...
o największych rozmiarach. Zakładając, że w dysku protoplanetarnym
rozmiar wiru jest porównywalna z grubością dysku $(H / l_{\textrm{T}} = 1)$ to
równanie~\mref{eq:velt} implikuje górne ograniczenie na
...
kinetycznej obiektu jest wyrażona poprzez:
%
\begin{equation}
   \label{eq:ekin}
   \tilde{E}_{\textrm{kin}} = \
