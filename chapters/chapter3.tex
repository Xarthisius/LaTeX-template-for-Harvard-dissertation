...
ściskane działającą do wewnątrz siłą samograwitacyjną. Po $150$~latach dysk
pyłowy staje się widocznie bardziej pofragmentowany w~kierunku azymutalnym w
porównaniu z modelem bez samograwitacji.
Odstępstwo od osiowej symetrii jest wyraźnie zauważalne. Formacje gęstego pyłu na
...
cały pył do jednej płaskiej warstwy w~płaszczyźnie $R - \varphi$ tworząc
długie, pofalowane włókna (Rysunek~\ref{fig:projs}). W~trakcie dalszej ewolucji
włókna fragmentują na mniejsze związane grawitacyjnie obiekty,
...
\end{equation}
%
Przy obliczaniu energii kinetycznej obiektu, poza transformacją wpółrzędnych do
układu środka masy, w~celu uwzględnienia wpływu rotacji obłoku na jego
kontrakcję, dodatkowo wzięto pod uwagę możliwy wpływ podskalowej turbulencji,
która nie jest opisywana przyjętym modelem:
{\bf To zdanie trzeba rozbić i rozwinąć. Oddzielnie napisać o rotacji i o
turbulencji podskalowej, bo nie wiadomo o co chodzi}
%
\begin{equation}
   \label{eq:ekin}
...
\end{equation}
%
{\bf To jest zbyt pobieżna analiza najważniejszego wyniku pracy}
