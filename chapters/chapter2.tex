...
w całej objętości. Przyjmujemy iż zewnętrzny potencjal~\mref{eq:phiext} jest
...
porusza się z prędkością keplerowską tak, aby równoważyć radialną skłądową
grawitacji.
...
szerokości $\sim0.5\AU$. W obszarach tych wszyskie wielkości płynowe są
...
zderzeniowy wzrost opisany w rozdziale 1. Pełne zestawienie użytych parameterów
