...
płynowym (funkcja już zaimplementowana w~kodzie PIERNIK~\cite{piernik2}) lub
...
własności niestabilności strumieniowej w przybliżeniu płynowym. Drugim, niemniej
