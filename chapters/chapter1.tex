...
jednak pamiętać, że turbulentny ośrodek możę wytwarzać lokalne, przejściowe
...
W dotychczasowych rozważaniach pomineliśmy wpływ pionowej składowej siły
...
gradientem ciśnienia~\mref{eq:zeq}, o tyle opadaniu pyłu nieprzeciwdziała żaden
...
mogłaby zatem prowadzić do wytworzenia się cienkiej i bardzo gęstej wartstwy
...
prowadzi do wzbudzenia się turbulencji w gazie. Na skutek wzjemnego sprzężenia
...
maksimum ciśnienia gazu, wzrasta wypadkowa siła z jaką pył oddziaływuje na gaz.
...
i przyspiesza dryft pyłu z otacząjacyh go obszarów. Normalnie gradient ciśnienia
