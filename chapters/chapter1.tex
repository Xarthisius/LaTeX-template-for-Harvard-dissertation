...
obserwacyjna takiego układu kreślą obiekty na tym etapie mianem \emph{klasy
...
\item[ii) oligarchiczny wzrost $\left(\km \rightarrow
   ...
   podobnymi prędkościami mają większe prawdopodobieństwo zderzenia, jako że
...
\par Aby zrozumieć pewne niedostatki powyżej hipotezy, należy
...
\par Alternatywną teorią, szczególnie wdzięcznie wyjaśniająca powstawanie
...
globalnych, stratyfikowanych dysków podlegających nie osiowo symetrycznym
...
Toomre'a~\mref{eq:toomre} jest formowanie się struktur spiralnych w dysku. Jak
pokazują symulacje numeryczne efekt ten zachodzi już dla $Q\lesssim 1.7$, a więc
za nim dysk stanie się na tyle chłodny i masywny aby ulec
...
podgrzewanie gazu~\cite{YC85}, stabilizując dysk. Podobnie,
kryterium~\mref{eq:toomre} nie uwzględnia destabilizujących efektów
...
lat~\cite{HB11, GHB12}. Biorąc jednak pod uwagę typowe wartości parametrów
...
jądra, ponieważ może zachodzić już w trakcie początkowych etapów formowania się
 układu protogwiazda -- dysk (kilkadziesiąt tysięcy lat), w przeciwieństwie do
