...
\begin{description}
   ...
   wartość stosunku gęstości pyłu do gęstości gazu $\epsilon$ wynosi 0.01. Zatem
   $\rho_d \sim 10^{-12}\g\cm^{-3}$) proces koagulacji zachodzi w skalach lat
   czy tez dziesiątek lat i może bardzo szybko prowadzić do wytworzenia się
...
jądra''~\footnote{ang. \emph{core-accretion}}. Najbardziej kluczowym i najmniej
zbadnym etapem powyższego scenariusza jest formowanie się planetezymali
