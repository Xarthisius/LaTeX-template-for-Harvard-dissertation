...
obiektami stacjonarnymi. Co więcej, obiekty klasy I posiadają wysokie tempa
...
\begin{equation}\label{eq:mri}
   \frac{\mathrm{d}}{\mathrm{d}r} j\frac{\mathrm{d}}{\mathrm{d}r}\left(\Omega^2\right) > 0.
\end{equation}
%
...
szczątkowej jonizacji gazu. Jeżeli założymy że źródłem jonizacji jest wysoko energetyczne
