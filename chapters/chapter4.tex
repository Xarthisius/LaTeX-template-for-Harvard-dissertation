...
protoplanetarnego w dwu i trzech wymiarach oraz liniowej analize stabilności
...
%
W eksperymentach numerycznycg przeprowadzonych dla ziaren pyłu o rozmiarach od
...
wykładniku $a = 1.25\pm0.12$. Wykładnik ten mieści się w przewidywaniach innych
...
obliczeniowej. Należy jednak mieć na uwadze, że dodatkową niepewności odnośnie
...
grawitacyjnego\mref{eq:ekin}. Jak pokazano w rozdziale~\ref{sec:sim_3d} dla
...
ponad $15\%$ całkowitej masy pyłu w dysku. Dalszym krokiem pozwalającym na
rozwinięcie przedstawionego w niniejszej pracy modelu dysku protoplanetarnego
...
początkowej funkcji masy obiektów grawitacyjnie związanych.  Pomimo, że dzięki
zastosowaniu AMR można efektywnie zwiększyć rozdzielczość liniową siatki
obliczeniowej o parę rzędów wielkości, to śledzenie w dysku rozciągającym się na
wiele jednostek astronomicznych obiektów których rozmiary nie przekraczają setek
kilometrów, nadal nastręcza spore trudności.  Naturalnym krokiem w takiej
sytuacji jest rozszerzenie algorytmu numerycznego o tzw. \emph{,,sink
particles''}. Sink particles są punktami materialnymi które oddziałują z
otaczającym je płynem tylko poprzez siły grawitacji i pochłaniają płyn
znajdujący się wewnątrz zadanego promienia akrecji zwiększając swoją
...
grawitacyjnie obiekty, co przy użytych obecnie metodach numerycznych nie było
